...
namespace inventory.Migrations.WebsiteDb
{
    ...
    [Migration("20201016083913_AddedOrderTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("newki_dotnet.Models.OnlineProduct", b =>
                {
            ...
            modelBuilder.Entity("newki_dotnet.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("newki_dotnet.Models.OrderProduct", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("newki_dotnet.Models.OrderProduct", b =>
                {
                    b.HasOne("newki_dotnet.Models.Order", "Order")
                        .WithMany("Products")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("newki_dotnet.Models.OnlineProduct", "Product")
                        .WithMany()
