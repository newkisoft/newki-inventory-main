...
namespace inventory.Controllers.Api
{
    ...
    [Route("api/TfoPrice")]
    public class TfoPriceController : Controller
    {
      private readonly IAwsService _awsService;
        ...
        public TfoPriceController(IRabbitMqService rabbitMqService,
        ...
        public IActionResult UpdateAsync([FromBody] UploadFile uploadFile)
        {
            ...
            inventoryMessage.Command = InventoryMessageType.TfoPrice.ToString();
