...
namespace inventory.Controllers.Api
{
    ...
    [Route("api/FdyPrice")]
    public class FdyPriceController : Controller
    {
        ...
        public FdyPriceController(IRabbitMqService rabbitMqService,
        ...
        public IActionResult UpdateAsync([FromBody] UploadFile uploadFile)
        {
            ...
            inventoryMessage.Command = InventoryMessageType.FdyPrice.ToString();
